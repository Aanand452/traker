...
const persona = [
    ...
    { id: 8, label: 'Not Applicable', value: 'Not Applicable' },
    { id: 8, label: 'Platform', value: 'Platform' },
    { id: 8, label: 'Sales', value: 'Sales' },
    { id: 8, label: 'Service', value: 'Service' },
    { id: 8, label: 'HR/Employees', value: 'HR/Employees' }
];
