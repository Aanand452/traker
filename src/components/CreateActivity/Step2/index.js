      ...
      <Fragment>
        ...
        <div className="slds-m-bottom_large slds-col slds-size_1-of-2">
          <Input
            ...
            label="Campaign Id"
            onChange={(event, data) =>
              this.props.handleChange("campaignId", data.value)
            }
          ...
          <Combobox
            events={{
              onSelect: (event, data) =>
                ...
                this.props.handleChange("format", data.selection),
            }}
            labels={{ label: "Format" }}
            name="format"
        ...
        <div className="slds-m-bottom_large slds-col slds-size_1-of-2 slds-form-element">
          ...
          <Textarea
            ...
            onChange={(event) =>
              this.props.handleChange("abstract", event.target.value)
            }
          />
        </div>
        <div
          className={`slds-col slds-size_1-of-4 slds-form-element ${
            this.props.error.startDate && "slds-has-error"
          }`}
        >
          <label className="slds-form-element__label">
            <abbr className="slds-required" title="required">
        ...
        <div
          className={`slds-col slds-size_1-of-4 slds-form-element ${
            this.props.error.endDate && "slds-has-error"
          }`}
        >
          <label className="slds-form-element__label">
            <abbr className="slds-required" title="required">
        ...
        <div className="slds-m-bottom_large slds-col slds-size_1-of-2">
          <Input
            ...
            onChange={(event, data) =>
              this.props.handleChange("asset", data.value)
            }
            onKeyPress={(e) => {
              if (e.key === "Enter") {
                e.preventDefault();
